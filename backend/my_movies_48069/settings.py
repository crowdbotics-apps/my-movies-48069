"""
Django settings for my_movies_48069 project.
...
ROOT_URLCONF = 'my_movies_48069.urls'
...
WSGI_APPLICATION = 'my_movies_48069.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "my_movies_48069 API",
    "DESCRIPTION": "API documentation for my_movies_48069 App",
    "VERSION": "v1",
}
